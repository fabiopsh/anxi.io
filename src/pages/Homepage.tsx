...
export default function Homepage() {
    ...
    return (
        <div className='d-flex position-fixed w-100 bg-color App align-items-center justify-content-center'>
            <div className='homepage-card d-flex flex-column align-items-center p-4 gap-3'>
                <h1>Anxi.io</h1>
                <h4 className='text-center fw-bolder'>Compila il tuo ABC per aiutarti nella terapia!</h4>
